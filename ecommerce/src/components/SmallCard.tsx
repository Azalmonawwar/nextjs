...
const SmallCard = ({ product }: any) => {
    ...
    return (
        <Link href={`/product/${product.product_id}`} className="">
            <div key={product.product_id} className=" aspect-h-1 aspect-w-1  overflow-hidden h-[150px] w-[150px] md:h-[280px] md:w-[280px] bg-gray-200 xl:aspect-h-8 xl:aspect-w-7">
                <Image
                    width={300}
                    height={300}
